...
SIZE_MB=5120
RUN_ID="$(date +%s)"
FUSE_FILE="/host/mnt/fuse/smart-read-5gb-${RUN_ID}.bin"
...
ls -lh ${FUSE_FILE}
echo WRITE_5GB_MS=\$dt_ms
echo WRITE_5GB_MBPS_APPROX=\$mbps
"
...
mbps=\$(( ${SIZE_MB}*1000/dt_ms ))
echo READ_MODE=\$mode
echo READ_5GB_MS=\$dt_ms
echo READ_5GB_MBPS_APPROX=\$mbps
"

echo "Completed smart read test for 5GiB file."
